...
def parse_args():
    ...
    # Path
    parser.add_argument('--model_save_path', type=str, default='models', help='checkpoint path, used for save model and training')
    parser.add_argument('--policy_model_path', type=str, default='gpt2', help='policy model and reference model path')
    parser.add_argument('--critic_model_path', type=str, default='outputs/rewardModel/1000_steps', help='critic model and reward model path')
    ...
    parser.add_argument('--data_path', type=str, default='data/ppo_data', help='dataset for training and validation')
    ...
    parser.add_argument('--maxlen_prompt', type=int, default=768, help='max len for training, including model prompt and response')
