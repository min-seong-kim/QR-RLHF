...
def parse_args(*args):
    ...
    parser.add_argument('--batch_size', type=int, default=4, help='training batch size for single GPU')
    ...
    parser.add_argument('--train_steps', type=int, default=1000, help='train steps')
    ...
    parser.add_argument('--save_per_step', type=int, default=500, help='save ckpt and save validation tensorboard per steps')
    parser.add_argument('--print_interval', type=int, default=5, help='print training state and save training tensorboard per steps')
    parser.add_argument('--validation_metric', type=str, default='rm_loss', help='metric to select the best model')
    ...
    # Path
    parser.add_argument('--data_path', type=str, default='data/hh-rlhf', help='dataset for training and validation')
    ...
    parser.add_argument('--logdir', type=str, default='outputs/tensorboard_log/reward/reward_model_en', help='path to save tensorboard logs')
    parser.add_argument('--model_save_path', type=str, default='outputs/rewardModel', help='checkpoint path, used for save model and training')
    parser.add_argument('--hf_model_name_or_path', type=str, default='gpt2', help='Hugging model name used to load tokenizer, configs and pretained models')
    
    # LLM settings
    parser.add_argument('--context_truncate', type=int, default=1024, help='max length for history')
    parser.add_argument('--delimiter', type=str, default='</s>', help='delimiter to seperate dialog history')
